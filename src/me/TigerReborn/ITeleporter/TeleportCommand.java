...
public class TeleportCommand implements CommandExecutor{
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if(cmd.getName().equalsIgnoreCase("tprequest")){
			...
			sender.sendMessage(ITeleporter.COLOR_CODE + "a" + "Sent teleport request to " + req.getTo());
			player.sendMessage(ITeleporter.COLOR_CODE + "a" + sender.getName() +" has requested to teleport to you.\n To accept this, type /tpraccept\n To deny, type /tprdeny");
		}
