...
public class TeleportRequestAcceptCommand implements CommandExecutor{
	...
	public void acceptTeleportHereRequest(TeleportRequest req){
		...
		from.sendMessage(IMetadataTP.COLOR_CODE + "a" + to.getName() + " has accepted your teleport request. Teleporting");
		to.sendMessage(IMetadataTP.COLOR_CODE + "a" + "Accepted request from " + from.getName());
