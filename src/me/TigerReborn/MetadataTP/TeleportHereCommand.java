...
public class TeleportHereCommand implements CommandExecutor{
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if(cmd.getName().equalsIgnoreCase("tphererequest")){
			...
			sender.sendMessage(IMetadataTP.COLOR_CODE + "a" + "Sent teleport here request to " + req.getTo());
			player.sendMessage(IMetadataTP.COLOR_CODE + "a" + sender.getName() + " has requested that you teleport to them.\n To accept this, type /tpraccept\n To deny, type /tprdeny");
		}
		return true;
	}
